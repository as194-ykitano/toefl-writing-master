    ...
    <ProtectedRoute>
      <div className="max-w-6xl mx-auto px-8 py-8">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">邱乗ｼ皮ｿ貞屓謨ｰ ({selectedTaskType === 'task1' ? 'Task 1' : 'Task 2'})</CardTitle>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">蟷ｳ蝮・せ繧ｳ繧｢ ({selectedTaskType === 'task1' ? 'Task 1' : 'Task 2'})</CardTitle>
                <TrendingUp className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{filteredAverageScore}</div>
                <p className="text-xs text-muted-foreground">
                  {selectedTaskType === 'task1' ? 'Task 1' : 'Task 2'}繧ｨ繝・そ繧､縺ｮ蟷ｳ蝮・せ繧ｳ繧｢
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">譛鬮倥せ繧ｳ繧｢ ({selectedTaskType === 'task1' ? 'Task 1' : 'Task 2'})</CardTitle>
          ...
          <Card className="mb-8">
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle>繧ｹ繧ｳ繧｢謗ｨ遘ｻ ({selectedTaskType === 'task1' ? 'Task 1' : 'Task 2'})</CardTitle>
              ...
              {loading ? (
                ...
                <div className="text-center py-8">
                  <p className="text-gray-500">
                    {selectedTaskType === 'task1' ? 'Task 1' : 'Task 2'}縺ｮ繧ｨ繝・そ繧､縺梧署蜃ｺ縺輔ｌ縺ｦ縺・∪縺帙ｓ縲・
                  </p>
                  <p className="text-sm text-gray-400 mt-2">
                    莉悶・繧ｿ繧ｹ繧ｯ繧ｿ繧､繝励ｒ驕ｸ謚槭☆繧九°縲∵眠縺励＞繧ｨ繝・そ繧､繧呈嶌縺・※縺ｿ縺ｦ縺上□縺輔＞縲・
                  </p>
                  <Button asChild className="mt-4 bg-green-600 hover:bg-green-700">
                    <Link href="/ielts-tasks">譁ｰ縺励＞繧ｨ繝・そ繧､繧呈嶌縺・</Link>
                  </Button>
                </div>
              ) : (
          ...
          <Card className="mb-8">
            <CardHeader>
              <CardTitle>譛ｪ遒ｺ隱阪・繝輔ぅ繝ｼ繝峨ヰ繝・け ({selectedTaskType === 'task1' ? 'Task 1' : 'Task 2'})</CardTitle>
            </CardHeader>
            <CardContent>
              {loading ? (
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Button asChild variant="outline" size="sm">
                            <Link href={`/ielts-dashboard/essays/${essay.id}`}>隧ｳ邏ｰ繧定ｦ九ｋ</Link>
                          </Button>
                        </div>
                      </div>
                      <div className="mt-2">
