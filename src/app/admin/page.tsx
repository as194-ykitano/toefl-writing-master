...
import { BookOpen, Database, ExternalLink, Users } from "lucide-react";
...
const cards = [
  ...
  { href: "/admin/guides", title: "使い方ガイド", text: "新仕様のガイド本文、スクリーンショット、公開状態を管理します。", icon: BookOpen, color: "bg-emerald-100 text-emerald-700" },
