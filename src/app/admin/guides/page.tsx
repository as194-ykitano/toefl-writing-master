...
export default function AdminGuidesPage() {
  ...
  return <main className="p-5 md:p-8"><div className="mx-auto max-w-7xl space-y-6">
    <header className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-sm font-medium text-blue-600">GUIDE MANAGEMENT</p><h1 className="mt-1 text-3xl font-bold">使い方ガイド</h1><p className="mt-2 text-sm text-slate-500">新仕様のガイド本文・スクリーンショット・公開状態を管理します。</p></div><Button onClick={() => { setDraft({ ...blank }); setCreateOpen(true); }}><Plus className="h-4 w-4"/>新規ガイド</Button></header>
